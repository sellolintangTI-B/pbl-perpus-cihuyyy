...
<div class="bg-baseColor font-poppins" x-data="{ activeFilter: 'semua' }">
    <div class="max-w-2xl mx-auto p-4">
        ...
        <div class="flex gap-4 mb-6 border-b-2 border-gray-200">
            <a href="/booking-berlangsung.php" class="pb-3 px-1 text-gray-500 hover:text-primary transition-colors">
                Berlangsung
            </a>
            <a href="/booking-riwayat.php" class="pb-3 px-1 text-primary font-medium border-b-2 border-primary -mb-0.5">
                Riwayat
            </a>
        </div>
        ...
        <div x-show="activeFilter !== 'semua' && document.querySelectorAll('[x-show]:not([style*=\" display: none\"])').length===0"
