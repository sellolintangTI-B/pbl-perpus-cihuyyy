...
?>
<div class="bg-baseColor font-poppins h-screen md:min-h-[32rem]" x-data="{ onModalShow: false, showFeedback: false }">
    <div class="max-w-6xl mx-auto p-4">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 mb-4 border border-gray-400 flex flex-col items-start justify-start gap-4">
            ...
            <?php if (($bookingDetail['status'] == $statusEnum["created"]) && $authUser->user['id'] === $data['booking']->user_id): ?>
