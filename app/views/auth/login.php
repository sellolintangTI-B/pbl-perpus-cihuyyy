    ...
    <div class="max-w-7xl h-[90vh] w-full flex items-center justify-center overflow-hidden rounded-xl shadow-md shadow-gray-400 bg-white/20 p-6">
        ...
        <div class="h-full w-full overflow-y-auto px-8 py-6 ">
            <div class="w-full h-full max-w-md mx-auto flex flex-col justify-center">
                <h1 class="text-3xl font-medium font-poppins text-secondary-100 text-center mb-8">
                    Login
                </h1>
                <form class="w-full grid grid-cols-1 gap-4" action="<?= URL ?>/auth/signin" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                    <div class="w-full text-sm flex justify-between col-span-1 text-secondary-100">
                        <div class="flex gap-4 items-center ">
                            <input type="checkbox" id="remember_me" name="remember_me" value="true" class="w-4 h-4 bg-secondary-100 active:bg-secondary-100 cursor-pointer text-secondary-100 " />
                    ...
                    <button type="submit" class="w-full bg-secondary-100 text-white px-4 py-2 rounded-md cursor-pointer shadow-sm shadow-gray-400 hover:shadow-md hover:shadow-primary-100 duration-300 transition-all font-medium">
                        Login
                    </button>
                    <div class="w-full text-sm flex justify-center items-center gap-2 col-span-1 mt-8">
                        <p class="text-secondary-100">Don't have an account?</p>
                        <a class="text-primary-100 cursor-pointer" href="/auth/register">
                            Register Now
                        </a>
                    </div>
