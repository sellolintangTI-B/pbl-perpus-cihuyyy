<div class="w-full h-full flex items-center justify-center" x-data="{isOpen: false}">
    <button class="text-white bg-primary rounded-lg p-2 cursor-pointer" @click="isOpen = !isOpen">
        TEST MODAL
    </button>
    <div class="w-full h-full bg-black/20 z-50 absolute" x-show="isOpen" x-cloak>
        laala
    </div>
</div>
