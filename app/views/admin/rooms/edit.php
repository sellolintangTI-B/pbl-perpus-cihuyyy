        ...
        <div class="flex-1 w-full overflow-y-auto">
            <div class="flex items-center justify-center">
                <form class="w-full max-w-3xl grid grid-cols-1 sm:grid-cols-2 gap-6" action="<?= URL ?>/admin/room/update/<?= $data->id ?>" method="post" enctype="multipart/form-data">
                    ...
                    FormInput::input(id: 'deskripsi', name: 'description', label: 'Deskripsi', placeholder: "masukkan deskripsi ruangan", required: true, value: $data->description);
                    FormInput::input(id: 'jenis_ruangan', name: 'isSpecial', label: 'Jenis Ruangan', value: $data->is_operational);
                    FormInput::input(id: 'kapasitas_minimal', name: 'min', type: 'number', label: 'Kapasitas Minimal', required: true, value: $data->min_capacity);
                    FormInput::input(id: 'kapasitas_maximal', name: 'max', type: 'number', label: 'Kapasitas Maximal', required: true, value: $data->max_capacity);
                    ?>
