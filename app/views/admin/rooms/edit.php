           ...
           <div class="flex-1 w-full overflow-y-auto">
                <div class="flex items-center justify-center">
                    <form class="w-full max-w-3xl grid grid-cols-1 sm:grid-cols-2 gap-6" action="" method="post" enctype="multipart/form-data">
                        <?php
                        FormInput::input(id: 'nama', name: 'nama', label: 'Nama', placeholder:"masukkan nama ruangan", required: true);
                        FormInput::input(id: 'lantai', name: 'lantai', type: 'number', label: 'Lantai', placeholder:"contoh: 1", required: true);
                        FormInput::input(id: 'deskripsi', name: 'deskripsi', label: 'Deskripsi', placeholder:"masukkan deskripsi ruangan", required: true);
                        FormInput::input(id: 'jenis_ruangan', name: 'jenis_ruangan', label: 'Jenis Ruangan');
                        FormInput::input(id: 'kapasitas_minimal', name: 'kapasitas_minimal', type: 'number', label: 'Kapasitas Minimal', required: true);
                        FormInput::input(id: 'kapasitas_maximal', name: 'kapasitas_maximal', type: 'number', label: 'Kapasitas Maximal', required: true);
                        ?>
