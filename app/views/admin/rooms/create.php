        ...
        <div class="flex-1 w-full overflow-y-auto">
            <div class="flex items-center justify-center">
                <form class="w-full max-w-3xl grid grid-cols-1 sm:grid-cols-2 gap-6" action="<?= URL . "/admin/room/store" ?>" method="post" enctype="multipart/form-data">
                    <?php
                    FormInput::input(id: 'nama', name: 'name', label: 'Nama', placeholder: "masukkan nama ruangan", required: false);
                    FormInput::input(id: 'lantai', name: 'floor', type: 'number', label: 'Lantai', placeholder: "contoh: 1", required: false);
                    FormInput::input(id: 'deskripsi', name: 'description', label: 'Deskripsi', placeholder: "masukkan deskripsi ruangan", required: false);
                    FormInput::input(id: 'jenis_ruangan', name: 'isSpecial', placeholder: '1 / 0', label: 'is special?');
                    FormInput::input(id: 'kapasitas_minimal', name: 'min', type: 'number', label: 'Kapasitas Minimal', placeholder: 'contoh: 2', required: false);
                    FormInput::input(id: 'kapasitas_maximal', name: 'max', type: 'number', label: 'Kapasitas Maximal', placeholder: 'contoh: 4',  required: false);
                    ?>
