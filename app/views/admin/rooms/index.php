...
if (isset($_GET['isSpecial'])) $queryParams['isSpecial'] = $_GET['isSpecial'];
if (isset($_GET['floor'])) $queryParams['floor'] = $_GET['floor'];
...
<div class="w-full h-full flex flex-col items-start justify-start gap-5" x-data="{ onAlert: false, deleteRoomId: null }" @delete-room.window="onAlert = true; deleteRoomId = $event.detail.id">
    ...
    <!-- Tabel Ruangan -->
    <div class="p-4 bg-baseColor shadow-sm shadow-gray-600 rounded-xl w-full h-full border border-gray-200 overflow-auto">
