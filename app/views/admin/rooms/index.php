    ...
    <div class="p-6 bg-baseColor shadow-sm shadow-gray-600 rounded-xl w-full h-full border border-gray-200 overflow-auto">
        <table class="table-auto w-full border-collapse">
            ...
            <tbody class="text-primary divide-y divide-gray-100">
                <?php $no = 0;
                foreach ($data as $room): $no++; ?>
                    <tr
                        x-data="{ open: false }"
                        class="hover:bg-gray-50 transition-colors duration-150 text-center">
                        <td class="px-3 py-3 text-xs text-gray-700"><?= $no ?></td>

                        <td class="px-3 py-3 text-xs text-left font-medium text-gray-800">
                            <?= $room->name ?>
                        </td>

                        <td class="px-3 py-3 text-xs text-gray-600"><?= $room->floor ?></td>
                        <td class="px-3 py-3 text-xs text-gray-600"><?= $room->min_capacity ?></td>
                        <td class="px-3 py-3 text-xs text-gray-600"><?= $room->max_capacity ?></td>
                        ...
                        <td class="px-3 py-3 relative">
                            ...
                            <div
                                ...
                                <button
                                    ...
                                    class="flex items-center gap-2 px-3 py-2 text-xs text-red-600 hover:bg-red/5 border-t border-gray-100 w-full transition">
                                    <?= Icon::trash('w-3.5 h-3.5') ?> Hapus
                                </button>
                            </div>
                        </td>
                    </tr>
