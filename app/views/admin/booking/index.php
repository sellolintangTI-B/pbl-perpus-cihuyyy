...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('bookingFilter', (initialYear, initialMonth, initialDate) => ({
            ...
            month: initialMonth,
            date: initialDate,
            showFilter: false, // Variable ini sekarang hidup di scope utama
            days: [],

            // Text Display untuk Dropdown
            labels: {
                year: 'Tahun',
                month: 'Bulan',
                date: 'Pilih Tanggal'
            ...
            init() {
                // Set label awal jika ada value dari PHP
                ...
                // Generate tanggal saat pertama load
                this.updateDays();

                // Watcher: Jika tahun/bulan berubah, generate ulang tanggal
