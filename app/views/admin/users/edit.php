                ...
                <div class="w-full p-6 shadow-md border border-gray-300 rounded-xl bg-gray-50">
                    <form class="w-full grid grid-cols-1 sm:grid-cols-2 gap-6" action="<?= URL ?>/admin/user/update/<?= $data->id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-2 mt-4">
                            <button type="submit" name="register" class="w-full bg-primary text-white px-4 py-3 rounded-xl cursor-pointer shadow-sm shadow-gray-400 hover:shadow-md hover:shadow-primary transition-all duration-300 font-medium text-base">
                                Simpan Perubahan
                            </button>
                        </div>
                    </form>
            ...
            <div class="w-full">
                ...
                <div class="w-full p-6 shadow-md border border-gray-300 rounded-xl bg-gray-50">
                    <form class="w-full grid grid-cols-1 gap-6" action="<?= URL ?>/admin/user/reset_passwod/<?= $data->id ?>" method="post">
                        ...
                        <div class="mt-4">
                            <button type="submit" name="change_password" class="w-full bg-red text-white px-4 py-3 rounded-xl cursor-pointer shadow-sm shadow-gray-400 hover:shadow-md hover:shadow-red-300 transition-all duration-300 font-medium text-base">
                                Ganti Password
                            </button>
                        </div>
                    </form>
