...
class FormInput
{
    public static function input($id = '', $name = '', $type = 'text', $label = '', $value = '', $placeholder = '', $class = '', $classGlobal = '', $required = false, $readonly = false, $disabled = false, $color = '', $alpine_xmodel = '', $alpine_disabled = false, $attributes = [])
    {
