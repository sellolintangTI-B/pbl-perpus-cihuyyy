...
class Button
{
    ...
    public static function  button($label = '', $btn_icon_size = 'w-6 h-6', $icon = null, $rightIcon = null, $onClick = '', $type = '', $class = '', $name = '', $id = '', $color = 'primary', $alpineClick = '', $alpineDisabled = '', $disabled = false)
    {
