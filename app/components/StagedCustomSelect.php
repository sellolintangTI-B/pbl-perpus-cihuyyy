...
?>
        <div class="flex flex-col gap-2 justify-start relative w-full <?= $class ?>"
            ...
            <button
                ...
                type="button"
                class="flex w-full line-clamp-1 truncate gap-2 items-center shadow-md shadow-black/25 rounded-xl px-3 py-2 bg-primary hover:bg-primary/95 text-white cursor-pointer justify-between">
