<div class="<?=$classGlobal?> flex flex-col w-full gap-1 font-poppins">
    ...
    <div class="mt-2">
        ...
        <label 
            ...
            class="border-2 border-gray-300 rounded-lg px-4 py-4 w-full flex flex-col items-center justify-center cursor-pointer hover:border-gray-400 bg-white transition <?= isset($disabled) && $disabled ? 'opacity-50 cursor-not-allowed' : '' ?>"
