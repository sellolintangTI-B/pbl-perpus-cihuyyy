 ...
 <?php
    ...
    ?>
     <div class="fixed top-0 left-0 right-0 z-50 flex justify-center p-4 alert-slide">
         <div class="<?= 'bg-white rounded-md shadow-lg border-l-4 max-w-2xl w-full overflow-hidden ' . ($isSuccess ? 'border-tertiary' : 'border-tertiary') ?>">
             <div class="flex items-start p-4">
                 <?php if ($isSuccess) { ?>
                     <div class="shrink-0">
                         <svg class="w-6 h-6 text-tertiary" fill="currentColor" viewBox="0 0 20 20">
                 ...
                 <div class="ml-3 flex-1">
                     <h3 class="<?= 'text-sm font-medium mb-2 ' . ($isSuccess ? 'text-tertiary' : 'text-red') ?>">
